...
if __name__ == "__main__":
    ...
    for layout in [
        ...
        results = evaluate_bc_model(f"{layout}_1_single", curr_dir_1, curr_dir_2, bc_params)
        # threading.Thread(target=evaluate_bc_model, args=(f"{layout}_2", curr_dir_2, curr_dir_1, bc_params)).start()
        results = evaluate_bc_model(f"{layout}_2_single", curr_dir_2, curr_dir_1, bc_params)
